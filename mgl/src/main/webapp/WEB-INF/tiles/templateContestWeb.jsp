...
<link rel="stylesheet" href="/resources/ctW_css/css.css?ver1" type="text/css">
...
<body>
	<div id="wrap">
    	<tiles:insertAttribute name="leftWeb" ignore="true"/>
    	<div id="bodyzone">
    		<tiles:insertAttribute name="headerWeb" ignore="true"/>
    		<div id="container">
