...
<body>
	...
	$('.tabs_cont').navi_depth({pageNum:tab_s_no});		
			...
			<div class="content white_bg pt_00 visible_area_td" id="dis">
				...
				<table class="line_no">
					<tr>
						...
						<td class="btn_icons_td">
							<div class="icon_btn">
								<span id="re1" onclick="remove('1',this)"
									class="icon-remove re1" title="remove"></span>
							</div>
						</td>
						...
						<td class="btn_icons_td">
							<div class="icon_btn">
								<span id="re2" onclick="remove('2',this)"
									class="icon-remove re2" title="remove"></span>
							</div>
						</td>
					</tr>
				</table>
			...
			<div class="cet_lay pd_lrb gray_bg td_st td3 btn_full">
				...
				<div>
					<span class="btn_st btn_colorg popwin_btn"
