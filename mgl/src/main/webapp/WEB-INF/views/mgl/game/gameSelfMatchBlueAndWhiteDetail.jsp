			...
			<div class="content white_bg">
				<div class="room_data">
					...
					<div class="li_dot col_li">
						<span>2018.03.22 PM 06:00 ~ PM 08:00</span><span>계남다목적체육관(서울
							양천구 신정동)</span>
					</div>
				</div>
			</div>
				...
				<table class="game_td thead_td cet_lay">
					...
					<tbody>
						<tr>
							...
							<td>10</td>
							<td>청</td>
							<td class="ga_btn_s"><span class="i_file-view"
								onclick="location.href='/Game/GameSelfMatchBlueAndWhiteDetailSearch.techni'"></span></td>
						</tr>
						<tr>
							<td class="no_td">2</td>
						...
						<tr>
							<td class="no_td">1</td>
							<td class="ga_title">D 조 그룹(남.여)</td>
							<td>2</td>
							<td>청</td>
							<td class="ga_btn_s"><span class="i_file-view"
								onclick="location.href='/Game/GameSelfMatchBlueAndWhiteDetailSearch.techni'"></span></td>
