...
<%-- 		<header>
			...
			<div class="tab_bt_area white_bg">
				<div>
					<ul class="tabs_cont">
						<li class="active_tab"><span onClick="location.href='/UClub/GamePrivateStateInfo.techni'">개인리그</span>
						</li>
						<li><span
			...
			<div class="content white_bg" id="appendDiv">
			...
			<div class="tit_select pd_lrb gray_bg td_st td4 btn_full">
				...
				<div>
					<span class="btn_st btn_colorg popwin_btn1" onclick="location.href='#;'">게스트등록</span>
				</div>
