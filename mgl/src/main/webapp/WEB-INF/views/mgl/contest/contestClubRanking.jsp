...
<div class="tab_btn_b_area">
	<ul class="tab_btn_b">
		...
		<li class="active_tab" onClick="location.href='/Contest/ContestClubRanking.techni'">
			<span>클럽 순위</span>
		</li>
	</ul>
</div>
...
<div class="content white_bg pd_b0">
	...
	<table class="text_td">
		<tr>
			<td class="no_td">1</td>
			<td class="club_td"><span class="club_name"><%-- ${list. } --%>아이사랑클럽</span></td>
