	...
	<div id="wrap">
		...
		<div id="container">
			...
			<div class="tab_btn_b_area">
				<ul class="tab_btn_b">
					<li onClick="location.href='/Cfight/CfightEntryType.techni'"><span>종목별</span></li>
					<li onClick="location.href='/Cfight/CfightEntryClub.techni'" class="active_tab"><span>단체별</span></li>
				</ul>
			</div>
			<ul class="accordion_ul">
				...
				<c:set var="i" value="0" />
					<li>
						<ul class="accd_head">
							<li><span class="club_name-long">${list.c_nm }</span></li>
							<li>${list.group_count }팀</li>
						</ul> 
						<div class="accd_a">
							<table class="text_td">
								<c:forEach items="${list2}" var="list2">
									<c:if test="${list.c_idx eq list2.c_idx }">
										<c:set var="i" value="${i+1}" />
										<tr>
											<td class="no_td">${i }</td>
											<td class="ga_title">${list2.cf_t_nm }</td>
											<td class="n3_rank"><span class="name3">${list2.a1_nm }</span>
												<span class="age_rank">(${list2.a1_age }-${list2.a1_gd })</span></td>
											<td class="n3_rank"><span class="name3">${list2.b1_nm }</span>
												<span class="age_rank">(${list2.b1_age }-${list2.b1_gd })</span></td>
										</tr>
									</c:if>
								</c:forEach>
							</table>
